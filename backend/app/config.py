...
OPENAI_REPORT_MODEL = os.getenv("OPENAI_REPORT_MODEL", OPENAI_AUDIENCE_MODEL).strip() or OPENAI_AUDIENCE_MODEL
OPENAI_AUDIENCE_RATE_WINDOW_SECONDS = int(os.getenv("OPENAI_AUDIENCE_RATE_WINDOW_SECONDS", "3600"))
OPENAI_AUDIENCE_MAX_CALLS_PER_WINDOW = int(os.getenv("OPENAI_AUDIENCE_MAX_CALLS_PER_WINDOW", "180"))
OPENAI_AUDIENCE_MIN_INTERVAL_SECONDS = int(os.getenv("OPENAI_AUDIENCE_MIN_INTERVAL_SECONDS", "2"))
OPENAI_AUDIENCE_MAX_SESSION_CALLS = int(os.getenv("OPENAI_AUDIENCE_MAX_SESSION_CALLS", "60"))
